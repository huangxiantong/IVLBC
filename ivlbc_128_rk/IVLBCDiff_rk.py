...
class IVLBCDiff_rk:
    ...
    def MakeModel(self):
        """
        Generate the MILP model of IVLBC128_rk given the round number.
        """
    ...
    def Constraint(self):
        ...
        for i in range(0, self.Round):
            ...
            self.Constraintssss_rk(variablein_A[16],variableout_rk[56],variableout_rk[57],variableout_rk[58],variableout_rk[59])
            self.Constraintssss_rk(variablein_A[17], variableout_rk[60], variableout_rk[61], variableout_rk[62],variableout_rk[63])
    ...
    def CreateVariablesA(self, round):
        ...
        array = []
        for i in range(0, 18):
            array.append(("A" + "_" + str(round * 18 + i)))
        return array
    ...
    def VariableBinary(self):
        ...
        for i in range(0, self.Round):
            for j in range(0, 64):
                ...
                fileobj.write("\n")
            for j in range(0, 80):
                fileobj.write("k_" + str(128 + i * 128 + j))
                fileobj.write("\n")
            for j in range(0, 17):
    ...
    def SolveModel(self):
        """
        Solve the MILP model to search the differential path of IVLBC128_rk.
        """
