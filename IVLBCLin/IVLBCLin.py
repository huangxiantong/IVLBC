...
class IVLBCLin:
    ...
    def Constraint(self):
        ...
        fileobj.close()
        for i in range(0, self.Round):
            variablein = IVLBCLin.CreateVariables(self, i)
            # The constraints of Sub_Cells.
            variablein_y = IVLBCLin.CreateVariablesY(self, i)
            variablein_A = IVLBCLin.CreateVariablesA(self, i)
            ...
            variablein_z = IVLBCLin.CreateVariablesZ(self, i)
            self.VariableRotation(variablein_z, variablein_y)
            # The constraints of Mix_Columns.
            variableout_x = IVLBCLin.CreateVariables(self, i + 1)
    ...
    def SolveModel(self):
        """
        Solve the MILP model to search the linear path of IVLBC.
        """
