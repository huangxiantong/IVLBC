...
class IVLBCDiff:
    ...
    def Constraint(self):
        ...
        variableout = []
        d = IVLBCDiff.CreateVariablesdd(self, 0)
        if self.Round == 2:

            self.Constraints(variablein)
            variableout = self.VariableRotation(variablein)
            x_16 = IVLBCDiff.CreateVariable(self, "x", 16)
            x_17 = IVLBCDiff.CreateVariable(self, "x", 17)
            x_18 = IVLBCDiff.CreateVariable(self, "x", 18)
            x_19 = IVLBCDiff.CreateVariable(self, "x", 19)
            self.ConstraintsByLF(variableout[0], variableout[1], variableout[2], variableout[3], x_16, x_17, x_18, x_19,
                                 d[0])
            x_20 = IVLBCDiff.CreateVariable(self, "x", 20)
            x_21 = IVLBCDiff.CreateVariable(self, "x", 21)
            x_22 = IVLBCDiff.CreateVariable(self, "x", 22)
            x_23 = IVLBCDiff.CreateVariable(self, "x", 23)
            self.ConstraintsByLF(variableout[4], variableout[5], variableout[6], variableout[7], x_20, x_21, x_22, x_23,
                                 d[1])
            x_24 = IVLBCDiff.CreateVariable(self, "x", 24)
            x_25 = IVLBCDiff.CreateVariable(self, "x", 25)
            x_26 = IVLBCDiff.CreateVariable(self, "x", 26)
            x_27 = IVLBCDiff.CreateVariable(self, "x", 27)
            self.ConstraintsByLF(variableout[8], variableout[9], variableout[10], variableout[11], x_24, x_25, x_26,
                                 x_27, d[2])
            x_28 = IVLBCDiff.CreateVariable(self, "x", 28)
            x_29 = IVLBCDiff.CreateVariable(self, "x", 29)
            x_30 = IVLBCDiff.CreateVariable(self, "x", 30)
            x_31 = IVLBCDiff.CreateVariable(self, "x", 31)
            ...
            for i in range(1, self.Round - 1):
                ...
                x_16 = IVLBCDiff.CreateVariable(self, "x", 16 + (i) * 16)
                x_17 = IVLBCDiff.CreateVariable(self, "x", 17 + (i) * 16)
                x_18 = IVLBCDiff.CreateVariable(self, "x", 18 + (i) * 16)
                x_19 = IVLBCDiff.CreateVariable(self, "x", 19 + (i) * 16)
                self.ConstraintsByLF(variableout[0], variableout[1], variableout[2], variableout[3], x_16, x_17, x_18,
                                     x_19, d[0])
                x_20 = IVLBCDiff.CreateVariable(self, "x", 20 + (i) * 16)
                x_21 = IVLBCDiff.CreateVariable(self, "x", 21 + (i) * 16)
                x_22 = IVLBCDiff.CreateVariable(self, "x", 22 + (i) * 16)
                x_23 = IVLBCDiff.CreateVariable(self, "x", 23 + (i) * 16)
                self.ConstraintsByLF(variableout[4], variableout[5], variableout[6], variableout[7], x_20, x_21, x_22,
                                     x_23, d[1])
                x_24 = IVLBCDiff.CreateVariable(self, "x", 24 + (i) * 16)
                x_25 = IVLBCDiff.CreateVariable(self, "x", 25 + (i) * 16)
                x_26 = IVLBCDiff.CreateVariable(self, "x", 26 + (i) * 16)
                x_27 = IVLBCDiff.CreateVariable(self, "x", 27 + (i) * 16)
                self.ConstraintsByLF(variableout[8], variableout[9], variableout[10], variableout[11], x_24, x_25, x_26,
                                     x_27, d[2])
                x_28 = IVLBCDiff.CreateVariable(self, "x", 28 + (i) * 16)
                x_29 = IVLBCDiff.CreateVariable(self, "x", 29 + (i) * 16)
                x_30 = IVLBCDiff.CreateVariable(self, "x", 30 + (i) * 16)
                x_31 = IVLBCDiff.CreateVariable(self, "x", 31 + (i) * 16)
